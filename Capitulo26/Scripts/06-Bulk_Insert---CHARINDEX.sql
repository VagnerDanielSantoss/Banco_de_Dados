...
/* BULK INSERT - IMPORTA ARQUIVOS */

CREATE TABLE TBL_LANCAMENTO_CONTABIL
(
	CONTA INTEGER,
	VALOR INTEGER,
...
SELECT * FROM TBL_LANCAMENTO_CONTABIL;
GO

/* \t ==> É A TECLA "TAB" */
/* \n ==> É A TECLA "ENTER" */
BULK INSERT 
	TBL_LANCAMENTO_CONTABIL
FROM
	'D:\SQL_SERVER\Capitulo26\Arquivos\CONTAS.txt'
WITH
(
	FIRSTROW = 2,
	DATAFILETYPE = 'CHAR',
...
/* DESAFIO - 
UMA QUERY QUE TRAGA O NÚMERO DA CONTA E O SALDO (DEVEDOR OU CREDOR)
*/

SELECT CONTA,
			 VALOR,
			 CHARINDEX('D', DEBITO_CREDITO) AS "DEBITO",
			 CHARINDEX('C', DEBITO_CREDITO) AS "CREDITO",
			 CHARINDEX('C', DEBITO_CREDITO) * 2  -1 AS MULTIPLICADOR
FROM
	TBL_LANCAMENTO_CONTABIL
GO

SELECT CONTA,
              SUM(VALOR * (CHARINDEX('C', DEBITO_CREDITO) * 2  -1)) AS "SALDO"
FROM
	TBL_LANCAMENTO_CONTABIL
GROUP BY
	CONTA
