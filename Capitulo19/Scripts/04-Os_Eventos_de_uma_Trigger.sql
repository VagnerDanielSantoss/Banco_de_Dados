...
/* NESTA TRIGGER, É ADICIONADO O CAMPO EVENTO PARA DISTINGUIR "INSERT" OU "DELETE" */
CREATE TRIGGER BACKUP_PRODUTO_DELETE
...
BEGIN
	...
	INSERT INTO BACKUP.BKP_PRODUTO
	(IDBKP_PRODUTO, IDPRODUTO, NOME, FABRICANTE, VALOR, EVENTO)
	VALUES
	(NULL, OLD.IDPRODUTO, OLD.NOME, OLD.FABRICANTE, OLD.VALOR, "D");
...
| IDBKP_PRODUTO | IDPRODUTO | NOME                            | FABRICANTE | VALOR    | EVENTO |
+---------------+-----------+---------------------------------+------------+----------+--------+
|             1 |      1000 | TESTE                           | LG         |     0.10 | NULL   |
|             2 |         1 | TV QLED Q50D 50"                | SAMSUNG    |  2499.99 | NULL   |
|             3 |         2 | TV QLED Q50D 55"                | SAMSUNG    |  3199.99 | NULL   |
|             4 |         3 | TV OLED S90D 65"                | SAMSUNG    | 11799.45 | NULL   |
|             5 |         4 | TV QNED85 55"                   | LG         |  3895.10 | NULL   |
|             6 |         5 | TV QNED80T 55"                  | LG         |  3299.05 | NULL   |
|             7 |         6 | TV OLED EVO QLEDC4"             | SAMSUNG    |  6154.80 | NULL   |
|             8 |         7 | SOUNDBAR HW-Q800D               | SAMSUNG    |  3297.20 | NULL   |
|             9 |         8 | SOUNDBAR S95TR                  | LG         |  6300.10 | NULL   |
|            10 |         9 | LAVA-LOUÇAS 14 SERVIÇOS INOX    | BRASTEMP   |  4508.95 | NULL   |
|            11 |        10 | ASPIRADOR DE PÓ VERTICAL ERG26  | ELETROLUX  |  1218.03 | NULL   |
|            12 |         7 | SOUNDBAR HW-Q800D               | SAMSUNG    |  3297.20 | NULL   |
|            13 |         2 | TV QLED Q50D 55""               | SAMSUNG    |  3199.99 | D      |
+---------------+-----------+---------------------------------+------------+----------+--------+


/* TRIGGER PARA SABER SE NO CAMPO EVENTO É INSERÇÃO OU DELEÇÃO */
...
BEGIN
	...
	(IDBKP_PRODUTO, IDPRODUTO, NOME, FABRICANTE, VALOR, EVENTO)
	VALUES 
	(NULL, NEW.IDPRODUTO, NEW.NOME, NEW.FABRICANTE, NEW.VALOR, "I");
...
(IDPRODUTO, NOME, FABRICANTE, VALOR)
VALUES 
(NULL, "PLAYSTATION 5 PRO SSD 2T", "SONY", 6999.99);
...
|         9 | LAVA-LOUÇAS 14 SERVIÇOS INOX    | BRASTEMP   |  4508.95 |
|        10 | ASPIRADOR DE PÓ VERTICAL ERG26  | ELETROLUX  |  1218.03 |
|        11 | PLAYSTATION 5 PRO SSD 2T        | SONY       |  6999.99 |
+-----------+---------------------------------+------------+----------+

INSERT INTO PRODUTO
(IDPRODUTO, NOME, FABRICANTE, VALOR)
VALUES 
(NULL, "AIRFRYER ESSENTIAL XL WALLITA", "WALLITA", 799);
...
|        10 | ASPIRADOR DE PÓ VERTICAL ERG26  | ELETROLUX  |  1218.03 |
|        11 | PLAYSTATION 5 PRO SSD 2T        | SONY       |  6999.99 |
|        12 | AIRFRYER ESSENTIAL XL WALLITA   | WALLITA    |   799.00 |
+-----------+---------------------------------+------------+----------+
